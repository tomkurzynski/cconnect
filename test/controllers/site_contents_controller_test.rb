...
class SiteContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create site_content" do
    assert_difference('SiteContent.count') do
      post site_contents_url, params: { site_content: { description1: @site_content.description1, description2: @site_content.description2, header1: @site_content.header1, header2: @site_content.header2, image: @site_content.image, title: @site_content.title } }
    end
  ...
  test "should update site_content" do
    patch site_content_url(@site_content), params: { site_content: { description1: @site_content.description1, description2: @site_content.description2, header1: @site_content.header1, header2: @site_content.header2, image: @site_content.image, title: @site_content.title } }
