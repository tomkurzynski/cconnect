...
class FiltersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filter" do
    assert_difference('Filter.count') do
      post filters_url, params: { filter: { brand: @filter.brand, category: @filter.category, price: @filter.price, weight: @filter.weight } }
    end
  ...
  test "should update filter" do
    patch filter_url(@filter), params: { filter: { brand: @filter.brand, category: @filter.category, price: @filter.price, weight: @filter.weight } }
