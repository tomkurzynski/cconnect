...
class WeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post weights_url, params: { weight: { description: @weight.description, title: @weight.title, value2: @weight.value2, value: @weight.value } }
    end
  ...
  test "should update weight" do
    patch weight_url(@weight), params: { weight: { description: @weight.description, title: @weight.title, value2: @weight.value2, value: @weight.value } }
